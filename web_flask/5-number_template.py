...
def c_route(text):
    """Displays 'C ' followed by the value of text (replace underscore _ symbols with a space)"""
    text = text.replace('_', ' ')
    return f'C {text}'
...
def python_route(text):
    """Displays 'Python ' followed by the value of text (replace underscore _ symbols with a space)"""
